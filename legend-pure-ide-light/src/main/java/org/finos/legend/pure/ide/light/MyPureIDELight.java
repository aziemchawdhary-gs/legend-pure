...
public class MyPureIDELight extends PureIDEServer
{
    public static void main(String[] args) throws Exception
    {
        new MyPureIDELight().run(args.length == 0 ? new String[] {"server", "legend-engine-pure-ide-light/src/main/resources/ideLightConfig.json"} : args);
    }
    ...
    public MutableList<RepositoryCodeStorage> buildRepositories(SourceLocationConfiguration sourceLocationConfiguration)
    {
        try
        {
            String ideFilesLocation = Optional.ofNullable(sourceLocationConfiguration)
                    ...
                    .orElse("../legend-engine/legend-engine-pure-ide-light/src/main/resources/pure_ide");
    ...
    {
        String resources = "../legend-engine/" + path + "/src/main/resources";
